...
| **Arsitektur Model** | Deep Neural Network (DNN) berbasis Keras dengan **DenseFeatures**, **Embedding Layers** untuk fitur kategorikal, **Batch Normalization**, 2 Hidden Dense Layers (**Layer 1: 96 unit**, **Layer 2: 16 unit**), **Dropout (0.3)**, **Learning Rate (0.001)** hasil optimasi komponen **Tuner (`tuner.py`)**, dan Sigmoid Output Layer untuk klasifikasi biner. |
