...
| **Arsitektur Model** | Deep Neural Network (DNN) berbasis Keras dengan **DenseFeatures**, **Embedding Layers** untuk fitur kategorikal, **Batch Normalization**, dan 2 Hidden Dense Layers (**Layer 1: 96 unit**, **Layer 2: 16 unit**), **Dropout (0.3)**, **Learning Rate (0.001)** hasil optimasi komponen **Tuner (`tuner.py`)**, serta Sigmoid Output Layer untuk klasifikasi biner. |
...
| **Performa Model** | Hasil komponen **Evaluator**: <br>- **BinaryAccuracy**: **0.9951** (99.51%) <br>- **AUC**: **0.9778** (97.78%) <br>- **Precision**: **0.9951** (99.51%) <br>- **Recall**: **1.0000** (100.00%) <br>Model dinyatakan **Blessed** oleh komponen Evaluator karena telah melampaui batas ambang evaluasi (`lower_bound` 0.70). |
